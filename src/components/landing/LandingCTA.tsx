  ...
  return <section className="container mx-auto px-4 py-20">
      <div className="max-w-3xl mx-auto text-center bg-gradient-hero rounded-3xl p-12 text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/auth">
            <Button variant="secondary" size="xl" className="border-white hover:bg-white/30 text-gray-950">
              Create My Free Profile
            </Button>
          </Link>
          <Button variant="outline" size="xl" className="border-white hover:bg-white/30 text-gray-950">
            Learn More
          </Button>
        </div>
      </div>
